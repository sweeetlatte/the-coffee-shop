...
//       productArrayList.add(new Product(2,"nameProduct",2000,"https://img.thuthuatphanmem.vn/uploads/2018/10/04/anh-dep-ben-ly-cafe-den_110730392.jpg"));
        ...
        productAdapter = new ProductAdapter(homeActivity.getApplicationContext(),productArrayList);
        recyclerViewNewProducts.setHasFixedSize(true);
        recyclerViewNewProducts.setLayoutManager(new GridLayoutManager(homeActivity.getApplicationContext(), 2));
